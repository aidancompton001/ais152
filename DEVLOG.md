...
**Статус:** 🟡 в работе. verify 8/9 — AC1 ждёт подписи ревьюера. Реестр 26 утверждений, H=0. Ревью #14: круг 6 — ОДОБРЕНО С ПРАВКАМИ по 24 утверждениям; утверждения 25 и 26 заведены после вердикта и подписи пока не имеют
...
**Шесть кругов ревью, один класс ошибки:** подпись под числом считает не то, что число.
