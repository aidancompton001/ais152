...
**Описание:** Персональный сайт-портфолио фрилансера/студии AIS.152 — разработка AI-powered приложений, мобильных платформ и автоматизация процессов. Showcasing: BauPreis AI, MONO, EDMI, Twitter 4.0. Двуязычный (EN/DE), тёмная тема, кастомный курсор, Aurora-эффекты, scroll-анимации.
